...
(function() {
    ...
    // B.vp = B.url.proto + B.url.domain.baidumap + "/";
     B.vp =bmapcfg.home;  //修改，本地工具资源引用(离/线路径)
    ...
    z.object.extend(K, {
        ...
        load: function(a, b, c) {
            ...
            if (e.Me == this.Cj.cq)
                ...
                // bmapcfg
				// 			mf = '/manhole-monitor/js/modules/'+a[i]+'.js';
    ...
    md.getTilesUrl = function(a, b, c) {
		...
		// return "/manhole-monitor/js/tiles" + "/" + b + "/" + e + "/" + a + ".jpg"; // 使用本地的瓦片
        return "http://localhost:9000/js/tiles" + "/" + b + "/" + e + "/" + a + ".jpg"; // 使用本地的瓦片
	}
    ;
    var La = new id("\u5730\u56fe",md,{
        tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
